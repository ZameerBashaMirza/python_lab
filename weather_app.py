...
def data_get():
    ...
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q=" +
                        city+"&appid=20a01944eda34a13f4a4dcecfff77197").json()
...
win = Tk()
win.title("zameer Project Day 1 ")
win.config(bg="blue")
win.geometry("500x570")

name_label = Label(win, text="Zameer Weather app",
...
com = ttk.Combobox(win, text="Zameer Weather app", values=list_name,
